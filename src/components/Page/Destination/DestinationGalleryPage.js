...
const urlSaveImgStr = Constants.DESTINATION_IMAGE_UPLOAD;
const token         = localStorage.getItem('token');
const urlDelImgStr  = Constants.DESTINATION_DELETE_IMAGE_API;  
const urlDefaultStr = Constants.DESTINATION_DEFAULT_IMAGE_API;
const urlStatusStr  = Constants.DESTINATION_STATUS_IMAGE_API


class DestinationGalleryPage extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            isMsg           : false,
...
export default DestinationGalleryPage;
