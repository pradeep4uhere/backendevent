...
const urlDelImgStr  = Constants.ITINERARIES_DELETE_DAY_IMAGE_API;  
const urlDefaultStr = Constants.ITINERARIES_DAY_DEFAULT_IMAGE_API;
const urlStatusStr = Constants.EVENT_STATUS_IMAGE_API;
const token     = localStorage.getItem('token');

class ItinerariesDayGalleryPage extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            isMsg           : false,
    ...
    render(){
       ...
       &nbsp;
       {
        ...
        return(
                ...
                <Breadcrum title={dayName+" Itinerary Day Image Gallery"} titleRight='All Itineraries Day List' url={'/viewitinerariedays?'+dayid} />
...
export default ItinerariesDayGalleryPage;
