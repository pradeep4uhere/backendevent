...
class ItinerariesAddOnPage extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    render(){
      ...
      return(
            ...
            <Breadcrum title="Add Travel Experience AddOn" titleRight='All Travel Experience List' url='allitineraries' />
            <SweetAlert
              dangerMode={true}
...
export default ItinerariesAddOnPage;