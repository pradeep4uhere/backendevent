...
class ItinerariesAddOnViewPage extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
        ...
        if(response.data[0].code==200) {
          console.log(response.data[0]);
            this.setState({
                ...
                itinerary_addon:response.data[0].data.itinerary_addon,
      ...
      return(
            ...
            <div className="box box-warning">
              ...
              <table className="table table-striped" style={{'font-size':'12px'}}>
                <tbody><tr>
                  <th>#</th>
                  <th style={{'white-space':'nowrap','font-size':'12px'}}>Title</th>
                  <th style={{'white-space':'nowrap','font-size':'12px'}}>Description</th>
                  <th>Status</th>
                </tr>
                {timingOption}
...
export default ItinerariesAddOnViewPage;